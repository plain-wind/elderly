...
const { imgSrc, activeName, name, position, examine }: Record<string, any> = route.query;
    ...
    <div class="detail-content">
      ...
      <div class="info-card">
        <div class="info-header">
          <div class="avatar-section">
            ...
            <div class="status-badge" :class="getStatusClass(examine)">
              {{ getStatusText(examine) }}
            </div>
          </div>
          <div class="basic-info">
            ...
            <div class="info-grid">
              ...
              <div class="info-item">
                ...
                <span>{{ volunteerDetails.contact }}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="stats-section">
          <div class="stat-item">
            <div class="stat-value">{{ volunteerDetails.rating }}</div>
            <div class="stat-label">服务评分</div>
            <StarRating :rating="Math.round(Number(volunteerDetails.rating))" />
          </div>
          <div class="stat-item">
            <div class="stat-value">{{ volunteerDetails.experience }}年</div>
            <div class="stat-label">服务经验</div>
          </div>
          <div class="stat-item">
            <div class="stat-value">{{ volunteerDetails.totalHours }}h</div>
            <div class="stat-label">服务时长</div>
          </div>
          <div class="stat-item">
            <div class="stat-value">{{ volunteerDetails.completedTasks }}次</div>
      ...
      <div class="detail-cards">
        ...
        <div class="detail-card">
          ...
          <div class="card-content">
            <div class="skills-list">
              <el-tag v-for="skill in volunteerDetails.skills" :key="skill" size="large" effect="plain"
                class="skill-tag">
                {{ skill }}
              </el-tag>
            </div>
        ...
        <div class="detail-card">
          ...
          <div class="card-content">
            <p class="description">{{ volunteerDetails.description }}</p>
          </div>
        </div>
      ...
      <!-- 审核操作 -->
      <div class="action-section" v-if="String(examine) === Status.Examine">
        <h3>审核操作</h3>
